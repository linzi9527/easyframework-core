...
import com.easyframework.core.db.Slave1DBHelper;


public class Slave1DaoImpl implements ISlave1Dao {
	
	private	Slave1DBHelper dbHelper=Slave1DBHelper.getInstance();
