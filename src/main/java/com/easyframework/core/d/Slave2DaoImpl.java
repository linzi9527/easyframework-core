...
import com.easyframework.core.db.Slave2DBHelper;


public class Slave2DaoImpl implements ISlave2Dao {
	
	private	Slave2DBHelper dbHelper=Slave2DBHelper.getInstance();
