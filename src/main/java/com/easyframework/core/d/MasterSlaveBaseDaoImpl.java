...
import com.easyframework.core.dbms.DBMasterSlaveHelper;
 ...
 */
public class MasterSlaveBaseDaoImpl implements IMsaterSlaveBaseDao {
	
	public	DBMasterSlaveHelper dbHelper=DBMasterSlaveHelper.getInstance();
