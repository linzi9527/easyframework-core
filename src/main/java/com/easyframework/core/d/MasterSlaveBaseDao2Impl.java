...
import com.easyframework.core.dbms.DBMasterSlaveHelper2;

public class MasterSlaveBaseDao2Impl implements IMsaterSlaveBaseDao {
	
	public	DBMasterSlaveHelper2 dbHelper=DBMasterSlaveHelper2.getInstance();
