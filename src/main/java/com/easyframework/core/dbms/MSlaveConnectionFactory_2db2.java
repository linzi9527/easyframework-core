...
public class MSlaveConnectionFactory_2db2 {
	private static Logger logger = Logger.getLogger(MSlaveConnectionFactory_2db2.class);
...
/*	static {
	...
	*/
	...
	//c3p0
	private static final String      MAXPOOLSIZE="db02_slave_MaxPoolSize";
	private static final String      MINPOOLSIZE="db02_slave_MinPoolSize";
	private static final String   IDLETESTPERIOD="db02_slave_idleConnectionTestPeriod";
	private static final String ACQUIREINCREMENT="db02_slave_acquireIncrement";
	private static final String  INITIALPOOLSIZE="db02_slave_initialPoolSize";
	private static final String    MAXSTATEMENTS="db02_slave_maxStatements";
	private static final String     HELPERTHEADS="db02_slave_numHelperThreads";
	private static final String         IDLETIME="db02_slave_maxIdleTime";
	private static final String    RetryAttempts="db02_slave_acquireRetryAttempts";
	private static final String       RetryDelay="db02_slave_acquireRetryDelay";
	private static final String          TIMEOUT="db02_slave_checkoutTimeout";
