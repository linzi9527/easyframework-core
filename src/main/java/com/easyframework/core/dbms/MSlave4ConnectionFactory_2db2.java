...
public class MSlave4ConnectionFactory_2db2 {
	private static Logger logger = Logger.getLogger(MSlave4ConnectionFactory_2db2.class);
...
/*	static {
	...
	//c3p0
	private static final String      MAXPOOLSIZE="db02_slave04_MaxPoolSize";
	private static final String      MINPOOLSIZE="db02_slave04_MinPoolSize";
	private static final String   IDLETESTPERIOD="db02_slave04_idleConnectionTestPeriod";
	private static final String ACQUIREINCREMENT="db02_slave04_acquireIncrement";
	private static final String  INITIALPOOLSIZE="db02_slave04_initialPoolSize";
	private static final String    MAXSTATEMENTS="db02_slave04_maxStatements";
	private static final String     HELPERTHEADS="db02_slave04_numHelperThreads";
	private static final String         IDLETIME="db02_slave04_maxIdleTime";
	private static final String    RetryAttempts="db02_slave04_acquireRetryAttempts";
	private static final String       RetryDelay="db02_slave04_acquireRetryDelay";
	private static final String          TIMEOUT="db02_slave04_checkoutTimeout";
