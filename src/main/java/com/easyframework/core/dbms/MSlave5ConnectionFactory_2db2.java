...
public class MSlave5ConnectionFactory_2db2 {
	private static Logger logger = Logger.getLogger(MSlave5ConnectionFactory_2db2.class);
...
/*	static {
	...
	*/
	...
	//c3p0
	private static final String      MAXPOOLSIZE="db02_slave05_MaxPoolSize";
	private static final String      MINPOOLSIZE="db02_slave05_MinPoolSize";
	private static final String   IDLETESTPERIOD="db02_slave05_idleConnectionTestPeriod";
	private static final String ACQUIREINCREMENT="db02_slave05_acquireIncrement";
	private static final String  INITIALPOOLSIZE="db02_slave05_initialPoolSize";
	private static final String    MAXSTATEMENTS="db02_slave05_maxStatements";
	private static final String     HELPERTHEADS="db02_slave05_numHelperThreads";
	private static final String         IDLETIME="db02_slave05_maxIdleTime";
	private static final String    RetryAttempts="db02_slave05_acquireRetryAttempts";
	private static final String       RetryDelay="db02_slave05_acquireRetryDelay";
	private static final String          TIMEOUT="db02_slave05_checkoutTimeout";
