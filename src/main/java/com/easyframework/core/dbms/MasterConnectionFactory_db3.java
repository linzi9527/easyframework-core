...
public class MasterConnectionFactory_db3 {
	private static Logger logger = Logger.getLogger(MasterConnectionFactory_db3.class);
...
/*	static {
	...
	//c3p0
	private static final String      MAXPOOLSIZE="db03_master_MaxPoolSize";
	private static final String      MINPOOLSIZE="db03_master_MinPoolSize";
	private static final String   IDLETESTPERIOD="db03_master_idleConnectionTestPeriod";
	private static final String ACQUIREINCREMENT="db03_master_acquireIncrement";
	private static final String  INITIALPOOLSIZE="db03_master_initialPoolSize";
	private static final String    MAXSTATEMENTS="db03_master_maxStatements";
	private static final String     HELPERTHEADS="db03_master_numHelperThreads";
	private static final String         IDLETIME="db03_master_maxIdleTime";
	private static final String    RetryAttempts="db03_master_acquireRetryAttempts";
	private static final String       RetryDelay="db03_master_acquireRetryDelay";
	private static final String          TIMEOUT="db03_master_checkoutTimeout";
