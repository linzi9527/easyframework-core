...
public class MSlave2ConnectionFactory_3db2 {
	private static Logger logger = Logger.getLogger(MSlave2ConnectionFactory_3db2.class);
...
/*	static {
	...
	//c3p0
	private static final String      MAXPOOLSIZE="db03_slave02_MaxPoolSize";
	private static final String      MINPOOLSIZE="db03_slave02_MinPoolSize";
	private static final String   IDLETESTPERIOD="db03_slave02_idleConnectionTestPeriod";
	private static final String ACQUIREINCREMENT="db03_slave02_acquireIncrement";
	private static final String  INITIALPOOLSIZE="db03_slave02_initialPoolSize";
	private static final String    MAXSTATEMENTS="db03_slave02_maxStatements";
	private static final String     HELPERTHEADS="db03_slave02_numHelperThreads";
	private static final String         IDLETIME="db03_slave02_maxIdleTime";
	private static final String    RetryAttempts="db03_slave02_acquireRetryAttempts";
	private static final String       RetryDelay="db03_slave02_acquireRetryDelay";
	private static final String          TIMEOUT="db03_slave02_checkoutTimeout";
